 ...
 *
 * 提供对 JVM 执行环境的访问的实用程序类，比如执行用户、启动选项或 JVM 版本等。
 */
public class EnvironmentInformation {
	 ...
	 *
	 * 返回由 Maven 生成的 Flink 代码的修订信息(提交id和提交日期)。
	 * 
	 ...
	 * and JVM parameters.
	 *
	 * 打印运行环境的信息，如代码修改信息、当前用户、java 版本 和 JVM参数。
	 *
	...
	/** Don't instantiate this class  不要实例化这个类 */
	 ...
	 * code.
	 * 修改信息封装了关于 Flink 源代码修改的信息：git 提交 id(哈希) 和 提交日期
	 */
